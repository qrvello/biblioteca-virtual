                            ...
                            @foreach ($content as $content)
                                <tr>
                                    ...
                                    <td class="admin-button">
                                        ...
                                        <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#contentModal{{$content->id}}">
                                            <svg width="1.5em" height="1em" viewBox="0 0 16 16" class="bi bi-window" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <!-- Modal -->
                                        <div class="modal fade" id="contentModal{{$content->id}}" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
