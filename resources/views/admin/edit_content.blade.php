...
<!-- Main content -->
<form action="{{url('/admin/contenido/crear/'.$content -> id )}}" method="POST" autocomplete="off"
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                            <input type="checkbox" @if ($content->active) checked="checked" @endif
                                            name="active">
                                        </div>
                                    </div>
                            ...
                            <div class="form-group col-md-12">
                                <x-upload-image-edit :content="$content"/>
                            </div>
                            ...
                            <div class="form-group col-mb-6">
                                ...
                                <select @if (!$content->subcategory) disabled="disabled" @endif class="custom-select"
